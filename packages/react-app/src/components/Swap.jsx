...
function Swap({ selectedProvider, tokenListURI }) {
    ...
    const activeChainId =
        process.env.REACT_APP_NETWORK === "kovan" ? ChainId.KOVAN : ChainId.MAINNET
    ...
    const executeSwap = async () => {
        ...
        try {
            ...
            if (exact === "in") {
                ...
                const _amountInMax = ethers.utils.hexlify(
                    ethers.BigNumber.from(amountInMax.raw.toString())
                )
                if (tokenIn === "ETH") {
            ...
            >
                <Descriptions title="Details" column={1} style={{ textAlign: "left" }}>
                    ...
                    <Descriptions.Item label="bestPrice">
                        {trades
                            ? trades.length > 0
                                ? trades[0].executionPrice.toSignificant(6)
                                : null
                            : null}
                    </Descriptions.Item>
                    <Descriptions.Item label="nextMidPrice">
                        {trades
                            ? trades.length > 0
                                ? trades[0].nextMidPrice.toSignificant(6)
                                : null
                            : null}
                    </Descriptions.Item>
                    <Descriptions.Item label="priceImpact">
                        {trades
                            ? trades.length > 0
                                ? trades[0].priceImpact.toSignificant(6)
                                : null
                            : null}
                    </Descriptions.Item>
